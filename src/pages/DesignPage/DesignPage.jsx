...
/* ----------------------------------------------------------- start ----------------------------------------------------------*/
  return (
    <div className='parent-container'>
      ...
      <div className="z-container">
        {/* 1st row - Oval Stadium */}
        <div className="z-row stadium">
          <div className="z-col">
            <figure>
              <img src={oval} className="z-img-fluid z-about-img" alt="Oval Stadium" style={{width:"300px",height:"200px",borderRadius:"1rem"}} />
            </figure>
          </div>
          <div className="z-col z-content-column info">
            <h1>Oval Stadium of Australia</h1>
            <p>
              The Oval Stadium, located in Australia, is one of the iconic sports venues in the world.
              It is known for hosting major cricket and football matches. The stadium has a rich history
        ...
        <div className="z-row stadium">
          ...
          <div className="z-col">
            <figure>
              <img src={ocean} className="z-img-fluid z-about-img" alt="Ocean" style={{width:"300px",height:"200px",borderRadius:"1rem"}} />
            </figure>
          </div>
        </div>
        {/* 2nd row end */}
